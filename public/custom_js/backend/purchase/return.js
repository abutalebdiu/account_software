    ...
    $(document).on('change keyup','.return_quantity_class',function(){
            setInputAndTextFieldAfterCalculation($(this).data('product_variation_id'));
    });
    ...
    $(document).on('change keyup','.discount_type_id_class ,.discount_value_class',function(){
        ...
        {
            return  (unitPurchasePrice(id) * returnQuantity(id)).toFixed(2);
        }
        ...
        function unitPurchasePrice(id)
        {
            return  $('#purchase_unit_id_'+id).val();
        }
        function saleQuantity(id)
        {
            return  parseFloat($('#purchase_quantity_id_'+id).val());
        }
