            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header bg-info">
                        ...
                        Inovice No : {{$sale_final->order_no}} (Sale Edit)
                        </span>
                    ...
                    <form action="{{route('sale.storeFromSaleUpdateFromSaleEditCart')}}" method="POST">
                        @csrf
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-right">
                                            ...
                                            <a href="{{route('sale.saleView')}}" class="btn btn-info"> Back </a>
