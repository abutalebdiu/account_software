@php
    ...
    <tr>
        ...
        <td>
            {{$i}})
            {{--
            <a href="#" class="popupModalWhenWantToEditCart" data-id="{{ $item['productVari_id'] }}" style="text-decoration:none;">
                <i class="fa fa-edit" style="font-size:20px;color: red;margin-right: 5px;background-color: aliceblue;"></i>
            </a>
              --}}
            {{ $item['name'] }}
