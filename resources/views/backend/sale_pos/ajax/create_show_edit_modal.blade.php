<div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('sale.addToCartWhenSubmitingEditFromModal')}}" method="POST" id="addToCartWhenSubmitingEditFromModal"> {{--id="addToCartFromProductShortDetailModal"--}}
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit"  class="cr_addToCart_button btn btn-info">Add To Cart</button>
                    </div>
                </form>
            </div>
        </div>
