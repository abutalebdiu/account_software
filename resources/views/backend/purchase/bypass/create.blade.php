...
<div class="page-content">
    ...
    <div class="page-breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Bypass Purchase</li>
        </ul>
    </div>
            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header bg-info">
                        <span class="widget-caption" style="font-size: 20px">Bypass Purchase</span>
                    </div>
                    <div class="widget-body">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label style="display: block;" for="">Supplier Name <a href="#" data-target="#supplierModal" data-toggle="modal" class="pull-right "><i style="color: #333; padding: 1px 8px;border: 2px solid #848484; border-radius: 3px;color:black;" class="fa fa-plus"></i></a> </label>
                                    <select id="supplier_id" name="supplier_id" class="supplier_id form-control select2">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select id="purchase_status_id" name="purchase_status_id" class="form-control select2">
                                        ...
                                        <option {{old('purchase_status_id') == 3 ?'selected':''}} value="3">Quotation</option>
                            ...
                            <input type="hidden" id="searchingProductByAjaxBypass" value="{{route('admin.purchase.product.searchingProductByAjaxBypass')}}"/>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input id="sumbitButton" type="submit" value="Submit" class="sumbitButton btn btn-primary">
...
@push('js')
    ...
    <script src="{{ asset('public') }}/custom_js/backend/purchase/bypass_create.js?v=1"></script>
