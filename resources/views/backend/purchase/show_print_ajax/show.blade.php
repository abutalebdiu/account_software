        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">
                    <strong>Purchase Details (Invoice No: {{$purchase->invoice_no}})</strong>
                                    ...
                                    <strong>Payment Status: </strong> 
                                     @if($purchase->totalPaidAmount() > 0)
                                        <span>
                                            ...
                                            @elseif($purchase->totalPurchaseAmount() > 0 && $purchase->totalPurchaseAmount()  < $purchase->totalPaidAmount())
                                                <small class="badge badge-warning"> Over</small><span class="badge badge-primary"> Paid </span>
                                            
                                            @elseif($purchase->totalPurchaseAmount() > 0 && $purchase->totalPurchaseAmount()  > $purchase->totalPaidAmount())
                                                <span class="badge badge-danger">Due</span>
                                            
                                            @elseif($purchase->totalPurchaseAmount() < 0)
            ...
            <div class="modal-footer">
                <a class="btn btn-primary viewSinglePrint" data-id="{{$purchase->id}}"><i class="fa fa-print"></i>Print</a>
