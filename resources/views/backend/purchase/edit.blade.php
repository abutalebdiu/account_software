            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header bg-info">
                        <span class="widget-caption" style="font-size: 20px">Edit Purchase</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input name="purchaes_date" value="{{ $purchase->created_at }}" type="date" class="form-control" >
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select id="purchase_status_id" name="purchase_status_id" class="form-control select2">
                                        ...
                                        <option {{ $purchase->status == 1 ?'selected':''}} value="1">Ordered & Receive <small>(Receive Product)</small></option>
                                        <option {{ $purchase->status == 2 ?'selected':''}} value="2">Ordered <small>(Receive Product Latter)</small> </option>
                                        <option {{ $purchase->status == 3 ?'selected':''}} value="3">Pending</option>
                                        <option {{ $purchase->status == 4 ?'selected':''}} value="4">Quotation</option>
                                        {{--  @foreach ($suppliers as $item)
