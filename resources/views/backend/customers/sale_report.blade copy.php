                                ...
                                <table id="example1" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ $customer->totalOrderInvoice() }}
                                                @php
                                                    $totalOrder += $customer->totalOrderInvoice();
                                                    $totalOrderAmount += $customer->totalSaleAmount();
                                                    $totalOrderPaidAmount += $customer->totalPaidAmount();
                                                    $totalOrderDueAmount += $customer->totalDueAmount();
                                                    $totalOrderDiscountAmount += $customer->discountAmountOfSaleFinal();
                                                    $totalOrderItem += $customer->totalOrderQuantity();
                                                @endphp
                                            </td>
                                            <td> {{ $customer->totalSaleAmount() }}</td>
                                            <td> {{ $customer->totalPaidAmount() }}</td>
                                            <td> {{ $customer->totalDueAmount() }}</td>
                                            <td> {{ $customer->discountAmountOfSaleFinal() }}</td>
                                            <td> {{ $customer->totalOrderQuantity() }}</td>
                                        </tr>
                                        @endforeach
