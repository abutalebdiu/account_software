<div class="modal fade payment_modal in" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel" style="font-size: calc(100%); display: block;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST" action="{{route('admin.saleReceiveBill')}}"  id="transaction_payment_add_form" enctype="multipart/form-data" novalidate="novalidate">
                @csrf
                <input name="sale_final_id" type="hidden" value="{{$saleFinal->id}}" />
                <input name="module_invoice_no"  type="hidden" value="{{$saleFinal->order_no}}" />
                <input name="customer_id"  type="hidden" value="{{$saleFinal->customer_id}}" />
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="well">
                                ...
                                : {{$saleFinal->customers?$saleFinal->customers->name:NULL}}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="well">
                                <strong>Invoice No.: </strong>{{$saleFinal->order_no}}
                                <br />
                        ...
                        <div class="col-md-4">
                            <div class="well">
                                <strong>Total amount: </strong><span class="" >৳ {{$saleFinal->totalSaleAmount()}}</span><br />
                                <strong>Paid Amount: </strong> ৳ {{ $saleFinal->totalPaidAmount() }}
                                <input type="hidden" value="{{ $saleFinal->totalSaleAmount() - $saleFinal->totalPaidAmount() }}" class="paid_amount" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input id="advance_balance" data-error-msg="Required advance balance not available" name="" type="hidden" value="0.0000" />
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        required=""
                                        placeholder="Amount" name="payment_amount" type="number"
                                        value="{{$saleFinal->totalSaleAmount() - $saleFinal->totalPaidAmount() }}"
                                        aria-required="true"
                                    />
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" readonly="" required="" name="payment_date" type="text" value="{{date('d-m-Y')}}" id="paid_on" aria-required="true" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input name="due_amount" type="text" class="total_due_amount_after_payment_class  form-control" readonly value="{{$saleFinal->totalSaleAmount() - $saleFinal->totalPaidAmount() }}" placeholder="Due Amount" style="font-size: 12px;color:red;font-weight:bold;">
                ...
                <div class="modal-footer">
                    <input type="submit" value="Save" disabled class="btn btn-primary submitButton" />
