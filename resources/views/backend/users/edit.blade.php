                             ...
                             <div class="row">
                                 <div class="col-sm-6">
                                     <div class="form-group">
                                         ...
                                         <input name="name" value="{{$user->name }}" type="text" placeholder="name" class="form-control">
                                 ...
                                 <div class="col-sm-6">
                                     <div class="form-group">
                                         ...
                                         <input name="email" type="text" value="{{$user->email}}" placeholder="email" class="form-control">
                                 ...
                                 <div class="col-sm-6">
                                     <div class="form-group">
                                         ...
                                         <input name="mobile" value="{{$user->mobile}}" type="text" placeholder="mobile" class="form-control">
                                 ...
                                 <div class="col-sm-6">
                                     <div class="form-group">
                                         ...
                                         <img src="{{ asset($user->image) }}" alt="" width="100"> <br>
