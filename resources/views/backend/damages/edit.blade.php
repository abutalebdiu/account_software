             ...
             <div class="col-xs-12 col-md-12">
                 <div class="widget">
                     <div class="widget-header bg-info">
                         <span class="widget-caption" style="font-size: 20px">Edit Damage Product</span>
                    </div>
                             ...
                             <div class="row">
                                         ...
                                         <label for="">Supplier</label>
                                          <select name="supplier_id" id="supplier_id" class="form-control">
                                              <option value="">Select Supplier</option>
                                               ...
                                               <option {{ $damage->supplier_id == $supplier->id ? 'selected' : '' }} value="{{ $supplier->id }}"> {{ $supplier->name }} </option>
                                               @endforeach
                                          </select>
                                         ...
                                         <label for="">Product </label>
                                          <select name="product_id" id="product_id" class="form-control">
                                              ...
                                              @foreach($products as $product)
                                               <option {{ $damage->product_id == $product->id ? 'selected' : '' }} value="{{ $product->id }}"> {{ $product->name }} </option>
                                 ...
                                 <div class="col-sm-4">
                                     <div class="form-group">
                                         ...
                                         <input name="price" id="price" value="{{ $damage->price }}"  onkeyup="offer()" type="text" placeholder="Price" class="form-control">
                                 ...
                                 <div class="col-sm-4">
                                     <div class="form-group">
                                         ...
                                         <input name="quantity" id="quantity" type="text"  onkeyup="offer()" value="{{$damage->quantity}}" placeholder="Quantity" class="form-control">
                                 ...
                                 <div class="col-sm-4">
                                     <div class="form-group">
                                         ...
                                         <input name="total_price" id="total_price"  onkeyup="offer()" type="text" value="{{$damage->total_price}}" placeholder="Total Price" class="form-control">
