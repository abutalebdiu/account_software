 @extends('home')
 @section('title','Pay Previous Purchase  Bill')
 @section('content')
 <!-- Page Content -->
 <div class="page-content">
     ...
     <div class="page-breadcrumbs">
         <ul class="breadcrumb">
             ...
             <li class="active">Pay Previous Purchase  Bill</li>
         </ul>
     </div>
     <!-- /Page Breadcrumb -->
     <!-- Page Header -->
             ...
             <div class="col-xs-12 col-md-12">
                 <div class="widget">
                     <div class="widget-header bg-info">
                         <span class="widget-caption" style="font-size: 20px">Pay Previous Purchase  Bill</span>
                     ...
                     <div class="widget-body">
                         <form action="{{route('admin.storePayPreviousPurchaseBill')}}" method="post">
                            @csrf
                             <div class="row">
                                 <div class="col-sm-6">
                                     <div class="form-group">
                                         <label for="">Supplier  Name</label>
                                            <select class="form-control supplier_id select2" name="client_supplier_id">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group pull-right">
                                        <a href="{{route('admin.payPreviousPurchaseBillList')}}" class="btn btn-info">Back</a>
 ...
 <!-- /Page Content -->
    ...
    <input  type="hidden" value="{{route('admin.purchasePreviousDueAmount')}}" class="purchasePreviousDueAmount" />

    @push('js')
        <!---- payment methods----->
        <script src="{{ asset('public') }}/custom_js/backend/payment/pay_previous_bill.js?v=1"></script>
