@extends('home')
@section('title','Payment List of Purchase Previous Bill  Report')
@section('content')
<!-- Page Content -->
<div class="page-content">
    ...
    <div class="page-breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Payment List of Purchase Previous Bill  Report</li>
        </ul>
    </div>
    <!-- /Page Breadcrumb -->
    <!-- Page Header -->
    <div class="page-header position-relative">
        <div class="header-title">
            <h1>
                Payment List of Purchase Previous Bill  Report
            </h1>
        </div>
        <!--Header Buttons-->
            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header bg-info">
                        <span class="widget-caption" style="font-size: 20px">Payment List of Purchase Previous Bill  Report</span>
                    ...
                    <div class="widget-body" style="background-color: #fff;">
                        ...
                        <div class="table-toolbar text-right" style="margin-bottom:4%;">
                            <a class="btn btn-primary pull-right"  href="{{route('admin.payPreviousPurchaseBill')}}"><i class="fa fa-plus"></i>Pay Previous Purchase Bill</a>
                        </div>
                        ...
                        <table id="example1" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting"style="width: 187px;" >Supplier</th>
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                         {{$payment->suppliers?$payment->suppliers->name:NULL}}<br/>
                                        <small>({{$payment->suppliers?$payment->suppliers->phone:NULL}})</small>
                                    </td>
                                    <td>
