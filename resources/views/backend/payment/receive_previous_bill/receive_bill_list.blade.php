@extends('home')
@section('title','Previous Sale Payment Report')
@section('content')
<!-- Page Content -->
<div class="page-content">
    ...
    <div class="page-breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Previous Sale Payment Report</li>
        </ul>
    </div>
    <!-- /Page Breadcrumb -->
    <!-- Page Header -->
            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header bg-info">
                        <span class="widget-caption" style="font-size: 20px">Previous Sale Payment Report</span>
                    ...
                    <div class="widget-body" style="background-color: #fff;">
                        ...
                        <div class="table-toolbar text-right" style="margin-bottom:4%;">
                            <a class="btn btn-primary pull-right"  href="{{route('admin.receivePreviousBill')}}"><i class="fa fa-plus"></i>Receive Previous Bill</a>
                        </div>

                        <table id="example1" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr role="row">
                                    <th class="sorting_asc" style="width: 163px;" >Invoice No</th>
                                    <th class="sorting" style="width: 158px;">Payment Ref No.</th>
                                    <th class="sorting"style="width: 187px;" >
                                        Customer 
                                    </th>
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        {{$payment->customers?$payment->customers->name:NULL}}<br/>
                                        <small>({{$payment->customers?$payment->customers->phone:NULL}})</small>
                                    </td>
                                    <td>
