            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header bg-info">
                        <span class="widget-caption" style="font-size: 20px">Godown Stock</span>
                            ...
                            <div class="row">
                                <form>
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-5">
                                            <a href="{{route('admin.secondary-stock.index')}}" class="btn btn-info">Back</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <form action="{{ route('admin.seconday_stock_pdf_list') }}" method="get">                   
